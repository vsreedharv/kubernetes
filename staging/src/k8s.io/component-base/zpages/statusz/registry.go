...
func (registry) minCompatibilityVersion() semver.Version {
	...
	minCompatVersion, err := semver.ParseTolerant(featuregate.DefaultComponentGlobalsRegistry.EffectiveVersionFor(featuregate.DefaultKubeComponent).MinCompatibilityVersion().String())
	if err != nil {
